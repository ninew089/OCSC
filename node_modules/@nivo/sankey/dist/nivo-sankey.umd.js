(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash/uniq'), require('react'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('d3-sankey'), require('@nivo/colors'), require('recompose/pure'), require('recompose/withPropsOnChange'), require('recompose/withState'), require('recompose/defaultProps'), require('recompose/compose'), require('lodash/cloneDeep'), require('react-motion'), require('recompose/withHandlers'), require('@nivo/tooltip'), require('d3-shape')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lodash/uniq', 'react', '@nivo/core', '@nivo/legends', 'prop-types', 'd3-sankey', '@nivo/colors', 'recompose/pure', 'recompose/withPropsOnChange', 'recompose/withState', 'recompose/defaultProps', 'recompose/compose', 'lodash/cloneDeep', 'react-motion', 'recompose/withHandlers', '@nivo/tooltip', 'd3-shape'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global['lodash/uniq'], global.React, global.nivo, global.nivo, global.PropTypes, global.d3, global.nivo, global.RecomposePure, global.RecomposeWithPropsOnChange, global.RecomposeWithState, global.RecomposeDefaultProps, global.RecomposeCompose, global['lodash/cloneDeep'], global.ReactMotion, global.RecomposeWithHandlers, global.nivo, global.d3));
}(this, (function (exports, _uniq, React, core, legends, PropTypes, d3Sankey, colors, pure, _withPropsOnChange, _withState, _defaultProps, _compose, _cloneDeep, reactMotion, withHandlers, tooltip, d3Shape) { 'use strict';

    _uniq = _uniq && _uniq.hasOwnProperty('default') ? _uniq['default'] : _uniq;
    ...
    _withState = _withState && _withState.hasOwnProperty('default') ? _withState['default'] : _withState;
