...
exports.applyMatrix2BBox = exports.getAngleByMatrix = exports.getMatrixByTranslate = exports.getMatrixByAngle = void 0;
...
function getMatrixByAngle(point, angle) {
    ...
    var m = matrix_util_1.ext.transform(identityMatrix, [
        ['t', -point.x, -point.y],
        ['r', angle],
        ['t', point.x, point.y],
    ]);
